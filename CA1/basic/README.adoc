...
11. At the end of the assignment, marking the repository with the tag ca1-part2.
...
Create a new branch to fix the invalid email issue and tag the repository at the end of the assignment.
